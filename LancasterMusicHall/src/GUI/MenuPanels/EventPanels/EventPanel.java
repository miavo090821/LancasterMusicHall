...
public class EventPanel extends JPanel {
    ...
    public void setBookingData(Booking booking) {
        ...
        startDatePicker.setDate(java.sql.Date.valueOf(booking.getStartDate()));
        endDatePicker.setDate(java.sql.Date.valueOf(booking.getEndDate()));
        startTimeCombo.setSelectedItem(booking.getStartTime().toString());
        endTimeCombo.setSelectedItem(booking.getEndTime().toString());
        activityIdField.setText(String.valueOf(booking.getActivity().getActivityId()));
        venueIdField.setText(String.valueOf(booking.getVenue().getVenueId()));
        heldCheck.setSelected(booking.isHeld());
    }
